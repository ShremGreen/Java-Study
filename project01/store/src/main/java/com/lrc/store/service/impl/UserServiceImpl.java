...
import com.lrc.store.service.ex.PasswordNotMatchException;
import com.lrc.store.service.ex.UserNotFoundException;
import com.lrc.store.service.ex.UsernameDuplicatedException;
...
public class UserServiceImpl implements IUserService {
    ...
    public void reg(User user) {
        ...
        */
        ...
        //异常处理
        if(row != 1) {
            throw new InsertException("用户注册发生未知异常！");
        }
    }
